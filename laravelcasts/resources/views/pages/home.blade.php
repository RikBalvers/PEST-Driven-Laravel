<x-guest-layout :page-title="config('app.name') . ' - Home'">
    ...
    <main>
        <div class="pt-10 bg-indigo-500 sm:pt-16 lg:overflow-hidden lg:pt-8 lg:pb-14">
                    ...
                    <div
                        ...
                        <div class="lg:py-24">
                            <h1
                                ...
                                <span
                                    class="block pb-3 text-transparent bg-gradient-to-r from-yellow-500 to-yellow-200 bg-clip-text sm:pb-5">keeps
                                    bugs away</span>
                            </h1>
                            <p class="text-base text-gray-200 sm:text-xl lg:text-lg xl:text-xl">
        ...
        <div class="relative py-16 bg-gray-50 sm:py-24 lg:py-32">
            <div class="relative">
                <div class="max-w-md px-4 mx-auto text-center sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:px-8">
                    <h2 class="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Pick one of our
                        exclusive premium courses</h2>
                    <p class="mx-auto mt-5 text-xl text-gray-500 max-w-prose">All of our courses will teach you one
                        specific aspect of programming. Go step by step and never stop learning.</p>
                </div>
                <div
                    class="grid max-w-md gap-8 px-4 mx-auto mt-12 sm:max-w-lg sm:px-6 lg:max-w-7xl lg:grid-cols-3 lg:px-8">
